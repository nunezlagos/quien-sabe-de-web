...
export function createContainer(context: unknown): Container {
...
export function getContainer(context: unknown): Container {
	if (!containerInstance) {
		containerInstance = createContainer(context);
	}
